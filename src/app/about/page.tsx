  ...
  return (
    <>
      ...
      <div className="flex space-x-3 p-8 items-center justify-start">
        ...
        <motion.div
          style={{
            width: useTransform(scrollYProgress, [0.1, 0.15], ["0%", "100%"]),
            originX: 0,
          }}
      ...
      <div className="flex justify-end pb-[100px] pt-[64px] px-8">
        <p className="font-main font-regular text-[20px] md:text-[25px] text-gray-dark text-left">
          I am an UX/UI Designer who values{" "}
      ...
      <div className="flex space-x-3 p-8 items-center justify-start">
        ...
        <motion.div
          style={{
            width: useTransform(scrollYProgress, [0.4, 0.45], ["0%", "100%"]),
            originX: 0,
          }}
          className="h-px bg-gray-dark"
        ></motion.div>
      ...
      <div className="flex space-x-3 p-8 items-center justify-start">
        ...
        <motion.div
          style={{
            width: useTransform(scrollYProgress, [0.7, 0.75], ["0%", "100%"]),
            originX: 0,
          }}
          className="h-px bg-gray-dark"
        ></motion.div>
