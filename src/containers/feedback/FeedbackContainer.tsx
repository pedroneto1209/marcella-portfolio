...
function FeedbackContainer() {
  ...
  return (
    <>
      <div
        id="feedback"
        className="flex space-x-3 p-8 items-center justify-start"
      >
      ...
      <div className="bg-white rounded-3xl m-8 p-8">
        <div className="flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-8 items-stretch justify-center">
          <div className="flex flex-col space-y-8 w-full md:w-1/2">
            ...
            <p className="font-main font-regular text-[16px] text-gray-dark">
              Marcella was one of the most competent people I have come across
              in over 10 years of professional experience. She was responsible
              for developing and managing the new Doebem website project,
              delivering it with high efficiency and quality. I highly recommend
              Marcella for her outstanding performance across the entire chain:
              UX/UI, Design, and impeccable management of both people and the
              entire process until the site launch.
            </p>
            <div className="flex space-x-3 items-center">
              <img
                src="images/bruno.png"
                alt="Bruno Sterenberg"
                className="w-15 h-15 object-cover rounded-full"
                style={{ width: "50px", height: "50px" }} // Enforce size in pixels
              />
          ...
          <div className="flex flex-col space-y-8 w-full md:w-1/2">
            ...
            <h1 className="font-main font-bold text-[39px] text-brand">“</h1>
            <p className="font-main font-regular text-[16px] text-gray-dark">
              Marcella played a crucial role in the planning and execution of
              the Doebem website design, leading both the UX and UI aspects.
              From the initial concept to the final implementation, she
              demonstrated responsibility, dedication, and passion throughout
              every stage of the project. The entire process of creating the
              design from scratch reflects her commitment to achieving
              excellence. Working with Marcella was an extremely positive
              experience, and I would love to have the opportunity to
              collaborate with her again. Without a doubt, I highly recommend
              Marcella&apos;s work to anyone or any team seeking a talented and
              dedicated professional. She is a valuable addition to any design
              team.
            </p>
            <div className="flex space-x-3 items-center">
              <img
      ...
      <div className="flex md:flex-row flex-col items-center justify-center">
        ...
        <div className="flex flex-1 flex-col space-y-8 items-start w-full my-8">
          ...
          <div className="flex space-x-4 mx-8">
            ...
            <Link href="https://www.linkedin.com/in/marcellacavalcanti2106/">
              <svg
                width="32"
                height="33"
                viewBox="0 0 32 33"
            ...
            <Link href="https://www.behance.net/marcellcavalca8">
              <svg
                width="32"
                height="33"
                viewBox="0 0 32 33"
            ...
            <Link href="https://medium.com/@marcellaclopes">
              <svg
                width="32"
                height="33"
                viewBox="0 0 32 33"
